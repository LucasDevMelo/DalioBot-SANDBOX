  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-900 text-gray-200">
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* Sidebar */}
        <div
          className={`absolute md:static z-50 transition-transform duration-300 transform bg-slate-900 border-r border-slate-800 shadow-lg md:shadow-none h-full md:h-auto ${
            ...
            <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50">
              <div className="bg-slate-800 border border-slate-700 p-6 rounded-2xl shadow-xl max-w-sm w-11/12">
                ...
                <div className="flex justify-end space-x-4">
                  ...
                  <button
                    onClick={() =>
                      roboParaExcluir && handleExcluirRobo(roboParaExcluir)
                    }
